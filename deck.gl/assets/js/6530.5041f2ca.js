...
`,getUniforms:function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:s;const e={};if(void 0!==t.pickingActive&&(e.picking_uActive=Boolean(t.pickingActive),e.picking_uAttribute=Boolean(t.pickingAttribute)),void 0!==t.pickingSelectedColor)if(t.pickingSelectedColor){const i=t.pickingSelectedColor.slice(0,3);e.picking_uSelectedColorValid=1,e.picking_uSelectedColor=i}else e.picking_uSelectedColorValid=0;if(t.pickingHighlightColor){const i=Array.from(t.pickingHighlightColor,(t=>t/255));Number.isFinite(i[3])||(i[3]=1),e.picking_uHighlightColor=i}return t.pickingColorRange&&(e.picking_uColorScale=1/t.pickingColorRange),e}}},39875:(t,e,i)=>{i.d(e,{Z:()=>s});const r=1e20;class s{constructor({fontSize:t=24,buffer:e=3,radius:i=8,cutoff:r=.25,fontFamily:s="sans-serif",fontWeight:n="normal",fontStyle:o="normal"}={}){this.buffer=e,this.cutoff=r,this.radius=i;const a=this.size=t+4*e,u=this._createCanvas(a),c=this.ctx=u.getContext("2d",{willReadFrequently:!0});c.font=`${o} ${n} ${t}px ${s}`,c.textBaseline="alphabetic",c.textAlign="left",c.fillStyle="black",this.gridOuter=new Float64Array(a*a),this.gridInner=new Float64Array(a*a),this.f=new Float64Array(a),this.z=new Float64Array(a+1),this.v=new Uint16Array(a)}_createCanvas(t){const e=document.createElement("canvas");return e.width=e.height=t,e}draw(t){const{width:e,actualBoundingBoxAscent:i,actualBoundingBoxDescent:s,actualBoundingBoxLeft:o,actualBoundingBoxRight:a}=this.ctx.measureText(t),u=Math.ceil(i),c=Math.max(0,Math.min(this.size-this.buffer,Math.ceil(a-o))),l=Math.min(this.size-this.buffer,u+Math.ceil(s)),h=c+2*this.buffer,p=l+2*this.buffer,f=Math.max(h*p,0),d=new Uint8ClampedArray(f),g={data:d,width:h,height:p,glyphWidth:c,glyphHeight:l,glyphTop:u,glyphLeft:0,glyphAdvance:e};if(0===c||0===l)return g;const{ctx:v,buffer:b,gridInner:y,gridOuter:m}=this;v.clearRect(b,b,c,l),v.fillText(t,b,b+u);const _=v.getImageData(b,b,c,l);m.fill(r,0,f),y.fill(0,0,f);for(let n=0;n<l;n++)for(let t=0;t<c;t++){const e=_.data[4*(n*c+t)+3]/255;if(0===e)continue;const i=(n+b)*h+t+b;if(1===e)m[i]=0,y[i]=r;else{const t=.5-e;m[i]=t>0?t*t:0,y[i]=t<0?t*t:0}}n(m,0,0,h,p,h,this.f,this.v,this.z),n(y,b,b,c,l,h,this.f,this.v,this.z);for(let r=0;r<f;r++){const t=Math.sqrt(m[r])-Math.sqrt(y[r]);d[r]=Math.round(255-255*(t/this.radius+this.cutoff))}return g}}function n(t,e,i,r,s,n,a,u,c){for(let l=e;l<e+r;l++)o(t,i*n+l,n,s,a,u,c);for(let l=i;l<i+s;l++)o(t,l*n+e,1,r,a,u,c)}function o(t,e,i,s,n,o,a){o[0]=0,a[0]=-r,a[1]=r,n[0]=t[e];for(let u=1,c=0,l=0;u<s;u++){n[u]=t[e+u*i];const s=u*u;do{const t=o[c];l=(n[u]-n[t]+s-t*t)/(u-t)/2}while(l<=a[c]&&--c>-1);c++,o[c]=u,a[c]=l,a[c+1]=r}for(let r=0,u=0;r<s;r++){for(;a[u+1]<r;)u++;const s=o[u],c=r-s;t[e+r*i]=n[s]+c*c}}}}]);