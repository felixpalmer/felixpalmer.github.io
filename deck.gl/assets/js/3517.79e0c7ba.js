...
`,r={};function l(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:r;if(!("material"in t))return{};const{material:e}=t;return e?function(t){const{ambient:e=.35,diffuse:i=.6,shininess:o=32,specularColor:n=[30,30,30]}=t;return{lighting_uAmbient:e,lighting_uDiffuse:i,lighting_uShininess:o,lighting_uSpecularColor:n.map((t=>t/255))}}(e):{lighting_uEnabled:!1}}const s={name:"gouraud-lighting",dependencies:[o.H],vs:n,defines:{LIGHTING_VERTEX:1},getUniforms:l},a={name:"phong-lighting",dependencies:[o.H],fs:n,defines:{LIGHTING_FRAGMENT:1},getUniforms:l}},35300:(t,e,i)=>{i.d(e,{q:()=>r});var o=i(27872);const n=new Float32Array([0,1,1,1]),r={name:"picking",vs:o.H`\
