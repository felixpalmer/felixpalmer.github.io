...
`,o={};function l(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:o;if(!("material"in e))return{};const{material:i}=e;return i?function(e){const{ambient:i=.35,diffuse:t=.6,shininess:n=32,specularColor:r=[30,30,30]}=e;return{lighting_uAmbient:i,lighting_uDiffuse:t,lighting_uShininess:n,lighting_uSpecularColor:r.map((e=>e/255))}}(i):{lighting_uEnabled:!1}}const a={name:"gouraud-lighting",dependencies:[n.H],vs:r,defines:{LIGHTING_VERTEX:1},getUniforms:l},u={name:"phong-lighting",dependencies:[n.H],fs:r,defines:{LIGHTING_FRAGMENT:1},getUniforms:l}}}]);