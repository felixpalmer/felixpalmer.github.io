"use strict";(self.webpackChunkproject_website=self.webpackChunkproject_website||[]).push([[9119],{41708:(i,t,e)=>{e.d(t,{Z:()=>r});var o=e(41199),n=e(53563);class r{constructor(i){this.id=void 0,this.topology=void 0,this.vertexCount=void 0,this.indices=void 0,this.attributes=void 0,this.userData={};const{attributes:t={},indices:e=null,vertexCount:r=null}=i;this.id=i.id||(0,o.hQ)("geometry"),this.topology=i.topology,e&&(this.indices=ArrayBuffer.isView(e)?{value:e,size:1}:e),this.attributes={};for(const[o,s]of Object.entries(t)){const i=ArrayBuffer.isView(s)?{value:s}:s;(0,n.h)(ArrayBuffer.isView(i.value),`${this._print(o)}: must be typed array or object with value as typed array`),"POSITION"!==o&&"positions"!==o||i.size||(i.size=3),"indices"===o?((0,n.h)(!this.indices),this.indices=i):this.attributes[o]=i}this.indices&&void 0!==this.indices.isIndexed&&(this.indices=Object.assign({},this.indices),delete this.indices.isIndexed),this.vertexCount=r||this._calculateVertexCount(this.attributes,this.indices)}getVertexCount(){return this.vertexCount}getAttributes(){return this.indices?{indices:this.indices,...this.attributes}:this.attributes}_print(i){return`Geometry ${this.id} attribute ${i}`}_setAttributes(i,t){return this}_calculateVertexCount(i,t){if(t)return t.value.length;let e=1/0;for(const o of Object.values(i)){const{value:i,size:t,constant:n}=o;!n&&i&&t>=1&&(e=Math.min(e,i.length/t))}return(0,n.h)(Number.isFinite(e)),e}}},59332:(i,t,e)=>{e.d(t,{H:()=>f});var o=e(41199);function n(i,t,e){if(i===t)return!0;if(!e||!i||!t)return!1;if(Array.isArray(i)){if(!Array.isArray(t)||i.length!==t.length)return!1;for(let o=0;o<i.length;o++)if(!n(i[o],t[o],e-1))return!1;return!0}if(Array.isArray(t))return!1;if("object"==typeof i&&"object"==typeof t){const o=Object.keys(i),r=Object.keys(t);if(o.length!==r.length)return!1;for(const s of o){if(!t.hasOwnProperty(s))return!1;if(!n(i[s],t[s],e-1))return!1}return!0}return!1}function r(i){return Array.isArray(i)?0===i.length||"number"==typeof i[0]?i:null:function(i){return!ArrayBuffer.isView(i)||i instanceof DataView?null:i}(i)}var s=e(47407),l=e(34210),a=e(55866),c=e(65352),u=e(53563),h=e(63847);class g{constructor(i){this.id=void 0,this.userData={},this.topology=void 0,this.bufferLayout=[],this.vertexCount=void 0,this.indices=void 0,this.attributes=void 0,this.id=i.id||(0,o.hQ)("geometry"),this.topology=i.topology,this.indices=i.indices||null,this.attributes=i.attributes,this.vertexCount=i.vertexCount,this.bufferLayout=i.bufferLayout||[],this.indices&&(0,u.h)(this.indices.usage===h.l.INDEX)}destroy(){var i;this.indices.destroy(),this.attributes.positions.destroy(),this.attributes.normals.destroy(),this.attributes.texCoords.destroy(),null===(i=this.attributes.colors)||void 0===i||i.destroy()}getVertexCount(){return this.vertexCount}getAttributes(){return this.attributes}getIndexes(){return this.indices}_calculateVertexCount(i){return i.byteLength/12}}function d(i,t){if(t instanceof g)return t;const e=function(i,t){if(!t.indices)return;const e=t.indices.value;return i.createBuffer({usage:h.l.INDEX,data:e})}(i,t),{attributes:o,bufferLayout:n}=function(i,t){const e=[],o={};for(const[r,s]of Object.entries(t.attributes)){let t=r;switch(r){case"POSITION":t="positions";break;case"NORMAL":t="normals";break;case"TEXCOORD_0":t="texCoords"}o[t]=i.createBuffer({data:s.value,id:`${r}-buffer`}),e.push({name:t,format:`float32x${s.size}`})}const n=t._calculateVertexCount(t.attributes,t.indices);return{attributes:o,bufferLayout:e,vertexCount:n}}(i,t);return new g({topology:t.topology||"triangle-list",bufferLayout:n,vertexCount:t.vertexCount,indices:e,attributes:o})}var p=e(38908);class f{constructor(i,t){this.device=void 0,this.id=void 0,this.vs=void 0,this.fs=void 0,this.pipelineFactory=void 0,this.userData={},this.parameters=void 0,this.topology=void 0,this.bufferLayout=void 0,this.vertexCount=void 0,this.instanceCount=0,this.indexBuffer=null,this.bufferAttributes={},this.constantAttributes={},this.bindings={},this.uniforms={},this.pipeline=void 0,this.vertexArray=void 0,this._pipelineNeedsUpdate="newly created",this._attributeInfos={},this._gpuGeometry=null,this._getModuleUniforms=void 0,this.props=void 0,this.props={...f.defaultProps,...t},t=this.props,this.id=t.id||(0,o.hQ)("model"),this.device=i,Object.assign(this.userData,t.userData);const e={type:i.info.type,shaderLanguage:i.info.shadingLanguages[0],gpu:i.info.gpu,features:i.features},{vs:n,fs:r,getUniforms:s}=this.props.shaderAssembler.assembleShaders(e,this.props);if(this.vs=n,this.fs=r,this._getModuleUniforms=s,this.vertexCount=this.props.vertexCount,this.instanceCount=this.props.instanceCount,this.topology=this.props.topology,this.bufferLayout=this.props.bufferLayout,this.parameters=this.props.parameters,t.geometry&&(this._gpuGeometry=this.setGeometry(t.geometry)),this.pipelineFactory=t.pipelineFactory||p.g.getDefaultPipelineFactory(this.device),this.pipeline=this._updatePipeline(),this.vertexArray=i.createVertexArray({renderPipeline:this.pipeline}),this._gpuGeometry&&this._setGeometryAttributes(this._gpuGeometry),t.vertexCount&&this.setVertexCount(t.vertexCount),t.instanceCount&&this.setInstanceCount(t.instanceCount),t.indices)throw new Error("Model.props.indices removed. Use props.indexBuffer");t.indexBuffer&&this.setIndexBuffer(t.indexBuffer),t.attributes&&this.setAttributes(t.attributes),t.constantAttributes&&this.setConstantAttributes(t.constantAttributes),t.bindings&&this.setBindings(t.bindings),t.uniforms&&this.setUniforms(t.uniforms),t.moduleSettings&&this.updateModuleSettings(t.moduleSettings),this.setUniforms(this._getModuleUniforms()),Object.seal(this)}destroy(){this.pipelineFactory.release(this.pipeline)}draw(i){this.pipeline=this._updatePipeline(),this.pipeline.setBindings(this.bindings),this.pipeline.setUniforms(this.uniforms),this.pipeline.draw({renderPass:i,vertexArray:this.vertexArray,vertexCount:this.vertexCount,instanceCount:this.instanceCount})}setGeometry(i){const t=i&&d(this.device,i);return this.setTopology(t.topology||"triangle-list"),this.bufferLayout=v(this.bufferLayout,t.bufferLayout),this.vertexArray&&this._setGeometryAttributes(t),t}_setGeometryAttributes(i){this.vertexCount=i.vertexCount,this.setAttributes(i.attributes),this.setIndexBuffer(i.indices)}setTopology(i){i!==this.topology&&(this.topology=i,this._setPipelineNeedsUpdate("topology"))}setBufferLayout(i){this.bufferLayout=this._gpuGeometry?v(i,this._gpuGeometry.bufferLayout):i,this._setPipelineNeedsUpdate("bufferLayout"),this.pipeline=this._updatePipeline(),this.vertexArray=this.device.createVertexArray({renderPipeline:this.pipeline}),this._gpuGeometry&&this._setGeometryAttributes(this._gpuGeometry)}setParameters(i){n(i,this.parameters,2)||(this.parameters=i,this._setPipelineNeedsUpdate("parameters"))}setVertexCount(i){this.vertexCount=i}setInstanceCount(i){this.instanceCount=i}setShaderModuleProps(i){const t=this._getModuleUniforms(i),e=Object.keys(t).filter((i=>{const e=t[i];return!r(e)&&"number"!=typeof e&&"boolean"!=typeof e})),o={};for(const n of e)o[n]=t[n],delete t[n];Object.assign(this.uniforms,t),Object.assign(this.bindings,o)}updateModuleSettings(i){this.setShaderModuleProps(i)}setBindings(i){Object.assign(this.bindings,i)}setUniforms(i){this.pipeline.setUniforms(i),Object.assign(this.uniforms,i)}setIndexBuffer(i){this.vertexArray.setIndexBuffer(i)}setAttributes(i){i.indices&&s.c.warn(`Model:${this.id} setAttributes() - indexBuffer should be set using setIndexBuffer()`);for(const[e,o]of Object.entries(i)){var t;const i=this.bufferLayout.find((i=>i.name===e));if(!i)continue;const n=i.attributes?null===(t=i.attributes)||void 0===t?void 0:t.map((i=>i.attribute)):[i.name];let r=!1;for(const t of n){const i=this._attributeInfos[t];i&&(this.vertexArray.setBuffer(i.location,o),r=!0)}r||s.c.warn(`Model(${this.id}): Ignoring buffer "${o.id}" for unknown attribute "${e}"`)()}}setConstantAttributes(i){for(const[t,e]of Object.entries(i)){const i=this._attributeInfos[t];i?this.vertexArray.setConstant(i.location,e):s.c.warn(`Model "${this.id}: Ignoring constant supplied for unknown attribute "${t}"`)()}}_setPipelineNeedsUpdate(i){this._pipelineNeedsUpdate=this._pipelineNeedsUpdate||i}_updatePipeline(){return this._pipelineNeedsUpdate&&(this.pipeline&&s.c.log(1,`Model ${this.id}: Recreating pipeline because "${this._pipelineNeedsUpdate}".`)(),this._pipelineNeedsUpdate=!1,this.pipeline=this.device.createRenderPipeline({...this.props,bufferLayout:this.bufferLayout,topology:this.topology,parameters:this.parameters,vs:this.device.createShader({id:"{$this.id}-vertex",stage:"vertex",source:this.vs}),fs:this.fs?this.device.createShader({id:"{$this.id}-fragment",stage:"fragment",source:this.fs}):null}),this._attributeInfos=(0,a.G5)(this.pipeline.shaderLayout,this.bufferLayout)),this.pipeline}}function v(i,t){const e=[...i];for(const o of t){const i=e.findIndex((i=>i.name===o.name));i<0?e.push(o):e[i]=o}return e}f.defaultProps={...l.h.defaultProps,vs:null,fs:null,id:"unnamed",handle:void 0,userData:{},defines:{},modules:[],moduleSettings:{},geometry:null,indexBuffer:null,attributes:{},constantAttributes:{},pipelineFactory:void 0,shaderAssembler:c.q.getDefaultShaderAssembler()}},41173:(i,t,e)=>{e.d(t,{N:()=>h,s:()=>g});var o=e(27872);const n=o.H`\
